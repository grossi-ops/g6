...
\item \textbf{``God is in everything''} (Vallabha's sarv\=atmat\=a-v\=ada) $\to$ The regeneration operator is all-pervading; every stable structure is an instance of the same G6 attractor.
...
Printed on 60\,lb cream \textperiodcentered\ Matte laminate\\
